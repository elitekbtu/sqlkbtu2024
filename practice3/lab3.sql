...
-- Task 2: Download lab3.sql file from intranet. Copy content of the file and run using Query Tool (check if tables created)
...
-- Task 10: Select the number of employees in each department. You only need to show the department code and the number of employees.
